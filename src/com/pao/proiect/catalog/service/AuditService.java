...
/**
 * Singleton thread-safe care logheaza actiunile in audit.csv.
 * Formatul fiecarei linii: nume_actiune,timestamp
 */
public class AuditService {
    ...
    private AuditService() {
        // scrie header doar daca fisierul e nou / gol
